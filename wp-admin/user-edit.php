...
<?php if ( ! ( IS_PROFILE_PAGE && ! $user_can_edit ) ) : ?>
	<tr class="user-rich-editing-wrap" style="display: none">
...
<?php endif; ?>
<?php if ( count($_wp_admin_css_colors) > 1 && has_action('admin_color_scheme_picker') && is_super_admin($current_user->ID) && is_super_admin($user_id) ) : ?>
...
<tr class="user-comment-shortcuts-wrap" style="display: none">
...
<?php endif; ?>
<tr class="show-admin-bar user-admin-bar-front-wrap" style="display: none">
...
<h3 style="display: none"><?php _e('Name') ?></h3>
...
<table class="form-table">
<tr class="user-description-wrap" style="display: none">
