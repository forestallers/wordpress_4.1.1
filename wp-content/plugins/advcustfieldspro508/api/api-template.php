...
function get_field( $selector, $post_id = false, $format_value = true ) {
	...
	error_log("Selector:  ".$selector." Post Id: ".$post_id);
	// get field
	$field = get_field_object( $selector, $post_id, false, false);
	error_log("field 1 ".print_r($field,true));
	...
	error_log("value 1 ".print_r($value,true));
...
function get_field_object( $selector, $post_id = false, $format_value = true, $load_value = true ) {
	...
	$field = acf_get_field( $selector );
	 error_log("1 get_field_object selector : ".$selector);
        error_log("1 get_field_object field : ".$field);
	...
	if( $override_name ) {
        ...
        error_log("2 get_field_object field : ".$field);
	...
	error_log("3 get_field_object field : ".$field);
	// format value
	if( $format_value ) {
	...
	error_log("4 get_field_object field : ".$field);
	// return
	return $field;
...
function acf_form( $args = array() ) {
	...
	if( $args['post_acc_facility'] )
	{
		$fields[] = acf_get_valid_field(array(
			'name'		=> '_post_acc_facility',
			'label'		=> 'Facility',
			'type'		=> 'taxonomy',
                        'taxonomy'      => 'facility',
			'value'		=> $post_id ? get_post_field('post_content', $post_id) : ''
